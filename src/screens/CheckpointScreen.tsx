  ...
  const handleCheckpoint = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // مباشرة إلى خطوة إرسال الاختيار بعد الحصول على معلومات التحقق
        setStep("choice");
      } else {
        Alert.alert("خطأ", result.message);
        onBack(); // العودة إذا فشل الحصول على معلومات التحقق
      }
    } catch (error: any) {
      Alert.alert("خطأ", `حدث خطأ: ${error.message}`);
      onBack(); // العودة في حالة وجود خطأ
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSendChoice = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // مباشرة إلى خطوة إدخال الكود بعد إرسال الاختيار
        setStep("code");
